...
$title = "Bon de Livraison - Étape 2/3";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_product'])) {
    ...
    $product = [
        ...
        'image' => null,
        'type' => 'BL' // Set product type to BL
    ];
...
<h1>Nouveau Bon de Livraison - Étape 2/3</h1>
...
<?php if (!empty($_SESSION['purchase_products'])): ?>
    ...
    <div class="form-actions">
        <a href="create_step1.php" class="btn btn-secondary">Retour</a>
        <a href="create_step3.php" class="btn btn-primary">Suivant</a>
    </div>
<?php else: ?>
