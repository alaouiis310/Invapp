...
$title = "Bons de Livraison d'Achat";
...
$suppliers = [];
$supplierQuery = $conn->query("SELECT DISTINCT SUPPLIER_NAME FROM BON_LIVRAISON_ACHAT_HEADER ORDER BY SUPPLIER_NAME");
...
$sql = "SELECT * FROM BON_LIVRAISON_ACHAT_HEADER WHERE 1=1";
$params = [];
$types = '';

// Add search term filter
if (!empty($searchTerm)) {
    $sql .= " AND (SUPPLIER_NAME LIKE ? OR ID_BON LIKE ?)";
    $params[] = "%$searchTerm%";
    $params[] = "%$searchTerm%";
    $types .= 'ss';
}
...
<h1>Bons de Livraison d'Achat</h1>

<div class="filters-container">
    <form action="" method="get" class="filter-form">
        <!-- Search by supplier or delivery note number -->
...
<div class="search-bar">
    <a href="create_step1.php" class="btn btn-success">
